...
export class SearchPlumberComponent implements OnInit {
    ...
    two(): void {
      this.router.navigate(['/search-plumber-rating'], {queryParams: {rating: 2}})
    }

    three(): void {
      this.router.navigate(['/search-plumber-rating'], {queryParams: {rating: 3}})
    }

    four(): void {
      this.router.navigate(['/search-plumber-rating'], {queryParams: {rating: 4}})
    }

    five(): void {
      this.router.navigate(['/search-plumber-rating'], {queryParams: {rating: 5}})
    }
